...
export default function NotificationsPage() {
  ...
  return (
    <div className="min-h-screen">
      <header className="sticky top-[var(--mg-mobile-top-header-h)] z-50 border-b border-zinc-200/60 bg-white min-[900px]:top-0 dark:border-zinc-800 dark:bg-zinc-900">
