...
export default function SavedPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)]">
      <header className="sticky top-[var(--mg-mobile-top-header-h)] z-30 border-b border-[var(--border)] bg-white/95 px-4 py-3 backdrop-blur-sm min-[900px]:top-0 dark:bg-[var(--background)]">
