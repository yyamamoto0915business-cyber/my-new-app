        ...
        <section className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm sm:p-8">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
            <div className="shrink-0">
              {organizer.avatarUrl ? (
                <div className="relative h-20 w-20 overflow-hidden rounded-full bg-slate-100 sm:h-24 sm:w-24">
                  <Image
                ...
                <div
                  className="flex h-20 w-20 items-center justify-center rounded-full bg-slate-100 text-2xl font-semibold text-slate-500 sm:h-24 sm:w-24"
                  aria-hidden
                >
            ...
            <div className="min-w-0 flex-1">
              ...
              {organizer.region && (
                <p className="mt-1 text-sm text-slate-500">{organizer.region}</p>
              )}
              {organizer.bio && (
