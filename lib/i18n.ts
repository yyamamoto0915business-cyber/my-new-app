...
> = {
  ja: {
    ...
    modeEvent: "まちの情報",
    modeEventDesc: "イベント・店舗・募集などをまとめて探す",
    modeVolunteer: "みんなの投稿",
    modeVolunteerDesc: "地域のみんなの投稿で、街の魅力を見つける",
    modeOrganizer: "主催",
  ...
  en: {
    ...
    modeEvent: "Town Info",
    modeEventDesc: "Find events, shops, volunteers, and more",
    modeVolunteer: "Community Posts",
    modeVolunteerDesc: "Discover local charm through community posts",
