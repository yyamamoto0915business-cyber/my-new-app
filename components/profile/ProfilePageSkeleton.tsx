...
export function ProfilePageSkeleton() {
  return (
    <div className="mg-profile-mobile-page relative min-h-screen w-full min-[900px]:bg-[#F7F8F5]">
      {/* Mobile skeleton */}
      <div className="mx-auto w-full max-w-screen-sm space-y-3 px-4 py-4 pb-24 animate-pulse min-[900px]:hidden sm:pb-8">
