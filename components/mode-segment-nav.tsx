...
export function ModeSegmentNav() {
  ...
  return (
    <nav
      className="fixed left-0 right-0 top-0 z-40 flex border-b border-[var(--border)] bg-white/95 pt-[env(safe-area-inset-top,0px)] backdrop-blur-sm sm:hidden dark:bg-[var(--background)]"
      aria-label="モード切替"
    >
