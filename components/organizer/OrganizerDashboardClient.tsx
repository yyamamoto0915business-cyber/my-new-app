...
import { OrganizerPlanHighlightCard } from "@/components/organizer/OrganizerPlanHighlightCard";
...
export default function OrganizerDashboardClient() {
  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      {planSummary && <OrganizerPlanHighlightCard planSummary={planSummary} />}
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <aside className="space-y-6">
          <section className="rounded-2xl border border-slate-200/80 bg-white p-4 shadow-sm sm:p-5">
            <h2 className="text-sm font-semibold text-slate-800">すぐ使う</h2>
          ...
          <section className="rounded-2xl border border-slate-200/80 bg-slate-50/50 p-4 sm:p-5">
            <h2 className="text-sm font-semibold text-slate-800">最初にやること</h2>
