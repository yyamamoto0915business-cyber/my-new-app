...
export function FeatureSettingCard({
  ...
  const actionClass = cn(
    "inline-flex min-h-[32px] items-center justify-center whitespace-nowrap rounded-[8px] border bg-white px-2.5 py-1.5 text-[11px] font-semibold transition hover:bg-[#fafaf8]"
  );
  ...
  return (
    <div
      className={cn(
        "flex flex-wrap items-center gap-2.5 rounded-[12px] border bg-white px-3 py-3",
        emphasized
    ...
    >
      ...
      <div className="min-w-0 flex-1 basis-[min(100%,12rem)]">
        ...
        {summaryLines && summaryLines.length > 0 ? (
          ...
          <p className="mt-0.5 line-clamp-2 text-[11px] leading-[1.5] text-[#888]">
            {description}
          </p>
        )}
      </div>
